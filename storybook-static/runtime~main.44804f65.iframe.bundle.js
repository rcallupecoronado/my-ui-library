(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        113: 'Components-Button-Button-stories',
        187: 'stories-Configure-mdx',
        191: 'Components-Text-Text-stories',
        207: 'Components-Img-Img-stories',
        290: 'stories-Page-stories',
        417: 'Components-Card-Card-stories',
        512: 'stories-Header-stories',
        535: 'Components-HeroImage-HeroImage-stories',
        615: 'Components-RadioButton-RadioButton-stories',
        743: 'Components-Dropdown-Dropdown-stories',
        791: 'stories-Button-stories',
        887: 'Components-Table-Table-stories',
        971: 'Components-Label-Label-stories',
      })[chunkId] || chunkId) +
      '.' +
      {
        113: '407e64f1',
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 'my_ui_library:' + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute('data-webpack', 'my_ui_library:' + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkmy_ui_library =
